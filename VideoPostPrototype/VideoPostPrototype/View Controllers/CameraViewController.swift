...
//        player.seek(to: CMTime(seconds: 0, preferredTimescale: 600)) // seconds = N/D, D = 600 (Apple recommends 600)
//        player.play()
    ...
    private func bestCamera() -> AVCaptureDevice {
        ...
        preconditionFailure("No cameras device match the specs we need.")
    }
    ...
    private func bestMicrophone() -> AVCaptureDevice {
        ...
        preconditionFailure("No microphones match specs.")
    }
